package com.developer.jdk8.test.designpatterns;
...
import com.developer.jdk8.designpatterns.abstractfactory.ComputerEngineer;
import com.developer.jdk8.designpatterns.abstractfactory.IntelFactory;
import com.developer.jdk8.designpatterns.builder.Director;
import com.developer.jdk8.designpatterns.builder.Product;
import com.developer.jdk8.designpatterns.decorator.ConcreteDecorator;
import com.developer.jdk8.designpatterns.inter.abstractfactory.AbstractFactory;
import com.developer.jdk8.designpatterns.inter.adapter.impl.Adapter;
import com.developer.jdk8.designpatterns.inter.builder.Builder;
import com.developer.jdk8.designpatterns.inter.builder.impl.ConcreteBuilder;
import com.developer.jdk8.designpatterns.inter.decorator.Component;
import com.developer.jdk8.designpatterns.inter.decorator.impl.ConcreteComponent;
...
import com.developer.jdk8.designpatterns.inter.factorymethod.impl.ExportPdfFactory;
import com.developer.jdk8.designpatterns.inter.observer.impl.ConcreteObserver;
...
import com.developer.jdk8.designpatterns.inter.prototype.impl.ConcretePrototypeRegister1;
import com.developer.jdk8.designpatterns.inter.prototype.impl.ConcretePrototypeSimple1;
import com.developer.jdk8.designpatterns.inter.proxy.Server;
import com.developer.jdk8.designpatterns.inter.proxy.impl.NginxProxy;
import com.developer.jdk8.designpatterns.inter.proxy.impl.NginxProxyInvocationHandler;
import com.developer.jdk8.designpatterns.inter.proxy.impl.SinaServer;
import com.developer.jdk8.designpatterns.inter.simplefactory.Login;
import com.developer.jdk8.designpatterns.inter.strategy.Strategy;
import com.developer.jdk8.designpatterns.inter.strategy.impl.ConcreteStrategyA;
import com.developer.jdk8.designpatterns.observer.ConcreteSubject;
import com.developer.jdk8.designpatterns.prototype.PrototypeManager;
import com.developer.jdk8.designpatterns.simplefactory.GenerateLogin;
import com.developer.jdk8.designpatterns.simplefactory.LoginFactory;
import com.developer.jdk8.designpatterns.simplefactory.ObjectPathConfig;
